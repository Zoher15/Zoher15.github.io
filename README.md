...
This Jekyll theme implements `collections` to let you break up your work into categories. The theme comes with a default `news` collection. Items from the `news` collection are automatically displayed on the home page.
